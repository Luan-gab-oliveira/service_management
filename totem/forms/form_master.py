...
try:
    ...
    class Application(func):
        ...
        def widgets(self):
            ...
            self.bt_Aut.place(anchor= 'center',relx= 0.25, rely=0.5, width= 425, height= 160) #Localizando o botão na tela
            ...
            self.bt_premir.place(anchor= 'center',relx= 0.75, rely=0.5, width= 425, height= 160) #Localizando o botão na tela
